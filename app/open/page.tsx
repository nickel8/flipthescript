...
const DOWNLOAD_URL = "https://github.com/nickel8/flipthescript/releases/download/v1.9/FlipTheScript-1.9.zip";
...
const steps = [
  {
    ...
    body: "Click the download button and wait for FlipTheScript-1.9.zip to finish downloading. Double-click the zip to unzip it — you'll see FlipTheScript.app appear.",
  },
  {
    n: "02",
